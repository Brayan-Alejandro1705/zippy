...
const PATHS = {
  ...
  destacado: (
    <>
      <path d="M12 21c3.9 0 6.5-2.6 6.5-6 0-4.5-4-6.5-4.5-11-2 1.5-3 3.5-3 5.5 0 1.2-1 2-1.9 1.2C8.3 10 8 9 8 8c-1.5 1.8-2.5 4-2.5 7 0 3.4 2.6 6 6.5 6z" />
    </>
  ),
  ...
  regalo: (
    <>
      ...
      <path d="M12 9S9.5 3.5 7 5.5 12 9 12 9zm0 0s2.5-5.5 5-3.5S12 9 12 9z" />
    </>
  ),

  corazon: (
    <>
      <path d="M12 20s-7.5-4.6-7.5-9.6A4.4 4.4 0 0112 8a4.4 4.4 0 017.5 2.4c0 5-7.5 9.6-7.5 9.6z" />
    </>
  ),

  taza: (
    <>
      <path d="M4 8h12v6.5a4 4 0 01-4 4H8a4 4 0 01-4-4V8z" />
  ...
  pan: (
    <>
      <path d="M4 12.5c0-3.3 3.6-5.5 8-5.5s8 2.2 8 5.5c0 1.2-1 2-2 2v2.5a2 2 0 01-2 2H8a2 2 0 01-2-2V14.5c-1 0-2-.8-2-2z" />
      <path d="M9.5 10.5l-1 5M14.5 10.5l1 5" />
    </>
  ),

  pastel: (
    <>
      <path d="M5 20.5v-6.2c0-1.3 1.1-2.3 2.4-2.3h9.2c1.3 0 2.4 1 2.4 2.3v6.2z" />
      <path d="M3.5 20.5h17" />
      <path d="M8.5 12V9M12 12V8.5M15.5 12V9" />
  ...
  verduras: (
    <>
      <path d="M12 8.5c0-2.5 2-4.5 4.5-4.5 0 2.5-2 4.5-4.5 4.5z" />
      <path d="M12 21c-3.6 0-6-3-6-6.5S8.4 8 12 8s6 3 6 6.5S15.6 21 12 21z" />
    </>
  ),

  lacteos: (
    <>
      <path d="M9 3.5h6v2.8l2.5 3.5V20a1 1 0 01-1 1h-9a1 1 0 01-1-1V9.8L9 6.3V3.5z" />
      <path d="M6.5 12h11" />
    </>
  ),
  ...
  carnes: (
    <>
      <path d="M15 3.5c3 0 5.5 2.4 5.5 5.4 0 2.6-1.8 4.7-4.2 5.3-.6 3.2-3.3 5.6-6.6 5.6a5.2 5.2 0 010-10.4c.6-3.4 2.8-5.9 5.3-5.9z" />
      <circle cx="9.7" cy="14.6" r="2.2" />
    </>
  ),

  taxi: (
    <>
      <path d="M3.5 16.5v-4l2-4.5h13l2 4.5v4" />
      <path d="M3.5 12.5h17" />
      <circle cx="7.5" cy="17" r="1.6" />
      <circle cx="16.5" cy="17" r="1.6" />
      <path d="M9.5 8V5.5h5V8" />
    </>
  ),

  camion: (
    <>
      <path d="M2.5 16.5v-9h11v9" />
  ...
  llave_inglesa: (
    <>
      <path d="M15.5 3.5a5 5 0 00-4.6 7l-7 7 2.6 2.6 7-7a5 5 0 006.2-6.4l-3 3-2.4-2.4 3-3a5 5 0 00-1.8-.8z" />
    </>
  ),

  ducha: (
    <>
      <path d="M12 3.5a4.5 4.5 0 00-4.5 4.5h9A4.5 4.5 0 0012 3.5z" />
      <path d="M6 8h12" />
      <path d="M9 12v1.5M12 12.5v2M15 12v1.5M10.5 16.5v1.5M13.5 17v2" />
    </>
  ),
  ...
  enviar: (
    <>
      ...
      <path d="M21.5 2.5l-6.7 19-3.8-8.5-8.5-3.8 19-6.7z" />
    </>
  ),
